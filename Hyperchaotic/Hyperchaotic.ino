...
void setup(){
  ...
  GD.putstr(17, 1, "Hyperchaotic map");
...
void loop(){
  ...
  float nx = x;
  x = 1.0f - a * powf(nx,2.0f) + c * (powf(y,2.0f) - powf(nx,2.0f));
  y = 1.0f - a * powf(y,2.0f) + c * (powf(nx,2.0f) - powf(y,2.0f));
  
  setpixel(117+(134*x), 117+(134*y), 255);
